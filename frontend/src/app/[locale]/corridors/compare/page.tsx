    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px]">
                ...
                <p className="text-muted-foreground dark:text-muted-foreground">Comparing corridors...</p>
            </div>
        );
    }
    ...
    if (selectedIds.length === 0) {
        return (
            <div className="text-center py-20 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-dashed border-gray-300 dark:border-slate-700">
                ...
                <p className="text-muted-foreground dark:text-muted-foreground mb-6 px-4">Select up to 3 corridors from the listing page to compare them side-by-side.</p>
                <Link
                    href="/corridors"
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <Link
                        href="/corridors"
                        className="p-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full transition-colors text-muted-foreground"
                    >
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            Corridor Comparison
                            <span className="text-sm font-normal text-muted-foreground dark:text-muted-foreground bg-gray-100 dark:bg-slate-700 px-2 py-0.5 rounded-full">
                    ...
                    {selectedIds.map((id) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="text-blue-500 hover:text-blue-700 dark:hover:text-link-primary"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        </div>
